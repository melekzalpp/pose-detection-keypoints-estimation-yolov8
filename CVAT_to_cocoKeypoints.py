...
out_dir = r'C:\Users\melek\Documents\myWork\Train pose detection Yolov8 on custom data  Keypoint detection'
if not os.path.exists(out_dir):
    os.makedirs(out_dir)

file = minidom.parse('C:\\Users\\melek\\Documents\\myWork\\Train pose detection Yolov8 on custom data  Keypoint detection\\annotations.xml')
